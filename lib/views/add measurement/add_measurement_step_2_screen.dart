...
class AddMeasurementStep2Screen extends StatelessWidget {
  const AddMeasurementStep2Screen({Key? key}) : super(key: key);

  // Abre el calendario
  Future<void> _seleccionarFecha(
      BuildContext context, AddMeasurementViewModel vm) async {
  ...
  // Abre el reloj para un índice concreto
  Future<void> _seleccionarHora(BuildContext context,
      AddMeasurementViewModel vm, int index) async {
    ...
    if (seleccionada != null) {
      vm.setHoraEnIndice(index, seleccionada);
    }
  }
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (_) =>
                                  const AddMeasurementStep3Screen(),
                                ),
                              );
                            },
                            child: const Text(
